                                ...
                                <article class="entry">
                                    ...
                                    @csrf
                                        <div class="position-relative form-group mt-4 entry-content">
                                            <label for="nama_kost" class=""><p style="font-weight: bold;">Nama Kost</p></label>
                                            <input name="nama_kost" id="nama_kost" type="text" placeholder="Masukkan Nama Kost" value="{{ $kost->nama_kost }}" class="form-control">
                                        </div>
                                        <div class="position-relative form-group mt-4 entry-content">
                                            <label for="kategori_kost" class=""><p style="font-weight: bold;">Kategori Kost</p></label>
                                        ...
                                        <div class="position-relative form-group mt-4 entry-content">
                                            <label for="fasilitas" class=""><p style="font-weight: bold;">Fasilitas</p></label>
                                        ...
                                        <div class="position-relative form-group mt-4 entry-content">
                                            <label for="ketereangan" class=""><p style="font-weight: bold;">Keterangan</p></label>
                                            <input name="keterangan" id="keterangan" type="text" placeholder="Masukkan Keterangan" value="{{ $kost->keterangan }}" class="form-control">
                                        </div>
                                        <div class="position-relative form-group mt-4 entry-content">
                                            <label for="harga" class=""><p style="font-weight: bold;">Harga Sewa</p></label>
                                        ...
                                        <div class="position-relative form-group mt-4 entry-content">
                                            <label for="fotokost" class=""><p style="font-weight: bold;">Foto Kamar</p></label>
                                            <input name="fotokost" id="fotokost" type="file" class="form-control" onchange="previewfotokost(this)">
                                            <img src="{{url('/images')}}/{{$kost->fotoKamar}}" id="previewfotokost" style="max-width: 350px; margin-top: 10px;">
                                            <label for="fotokost2" class=""><p style="font-weight: bold;">Foto Kamar(Opsional)</p></label>
                                            ...
                                            <!-- <label for="fotokost3" class=""><p style="font-weight: bold;">Foto Kamar(Opsional)</p></label>
